			...
			<div className='grid grid-cols-6 rounded-lg gap-3 p-5'>
				{imgPreview.map((item, idx) => (
					<div key={idx} className='relative'>
						...
						/>
						<TrashIcon
							className=' absolute top-2 right-2 h-8 p-1 text-red-800 border border-red-800 rounded-md bg-red-100 cursor-pointer active:shadow-md active:shadow-red-900'
