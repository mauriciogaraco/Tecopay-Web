...
import NuevoTicketModal from "../tickets/NewTicket/NuevoTicketModal";
import { data } from "../../utils/TemporaryArrayData";
import axios from "axios";
import EditUserContainer from "../tickets/editTicketWizzard/EditUserContainer";
import { useAppSelector } from "../../store/hooks";
import useServerEntity from "../../api/userServerEntity";
import { formatCalendar } from "../../utils/helpers";
import EditEntityContainer from "../Card/editEntityWizzard/EditEntityContainer";
...
const Entity = () => {
  ...
  useEffect(() => {
    ...
    getAllEntity(filter).then(allTickets? ()=>console.log(allTickets): ()=>console.log('moee'))
