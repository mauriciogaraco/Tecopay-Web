...
const PrintedStatus = () => {
	...
	const [filter, setFilter] = useState<Record<string, string | number | boolean | null>>({ page: 1, status: "PRINTED" });
	...
	const rowAction = (id: number) => {
		...
		const filterAction = (data: any) => {
			data ? setFilter({ ...data ,  status: "PRINTED" }) : setFilter({ page: 1 ,  status: "PRINTED" });
		};
